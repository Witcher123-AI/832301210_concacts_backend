...
- **成功响应**:
  - **状态码**: `200 OK`
  - **数据格式**: `[{"id": 1, "name": "cze", "phone": "12312312312"}]`
...
- **请求体**:
  ```json
  {"name": "shi", "phone": "45645645645"}
  ```
- **成功响应**:
  - **状态码**: `201 Created`
  - **数据格式**: `{"id": 2, "name": "shi", "phone": "45645645645"}`
...
- **请求体**:
  ```json
  {"name": "cze"（已更新）", "phone": "12312312312"}
  ```
- **成功响应**:
  - **状态码**: `200 OK`
  - **数据格式**: `{"id": 1, "name": "cze（已更新）", "phone": "12312312312"}`
